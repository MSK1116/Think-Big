...
const Events_banner1 = () => {
  return (
    <>
      <section className="overflow-hidden mt-9 bg-gray-50 sm:grid sm:grid-cols-2 sm:items-center">
        <div className="p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <div className="mt-4 md:mt-8">
              <button disabled className=" cursor-not-allowed inline-block rounded bg-emerald-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-emerald-700 focus:outline-none focus:ring focus:ring-yellow-400">
                Register
              </button>
            </div>
          </div>
        ...
        <div className=" bg-[url(/webi/handprint.jpg)] bg-cover  object-cover sm:h-[calc(100%_-_2rem)] sm:self-end sm:rounded-ss-[30px] md:h-[calc(100%_-_4rem)] md:rounded-ss-[60px]">
