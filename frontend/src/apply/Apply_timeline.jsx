...
const Apply_timeline = () => {
  return (
    <>
      <div className=" p-8 mb-10 max-w-screen-2xl w-full h-full">
        <h6 className=" text-xl font-semibold">Application timeline:</h6>
        <ol className=" mt-9 relative flex gap-8 before:absolute before:-mt-px before:h-0.5 before:w-full before:rounded-full before:bg-gray-200">
