      ...
      <div className=" min-h-screen space-y-32 mt-10 p-8 relative">
        ...
        <div className="h-full relative md:max-h-screen flex items-center flex-col md:flex-row mt-10">
          ...
          <div className=" hidden md:block">
            <TiGroup data-aos="zoom-in" data-aos-duration="1000" className=" absolute top-0 right-80 size-14 text-green-700/20" />
            <FaHandsHelping data-aos="zoom-in" data-aos-duration="1000" className=" absolute bottom-10  left-[35rem] size-14 text-green-700/20" />
            <IoSchoolSharp data-aos="zoom-in" data-aos-duration="1000" className=" absolute  -top-52 left-20 size-14 text-green-700" />
          </div>
        </div>
        <hr></hr>
        {/* 2 */}
        ...
        <div className="h-full md:max-h-screen relative flex flex-col md:flex-row mt-10">
          ...
          <div className=" hidden md:block">
            <FaSchool data-aos="zoom-in" data-aos-duration="1000" className=" absolute top-0 right-80 size-14 text-green-700/20" />
            <LuSchool data-aos="zoom-in" data-aos-duration="1000" className=" absolute bottom-0  left-52 size-14 text-green-700/20" />
            <IoSchoolSharp data-aos="zoom-in" data-aos-duration="1000" className=" absolute  top-0 left-20 size-14 text-green-700/20" />
          </div>
        </div>
        <hr></hr>
        {/* 3 */}
        <div className="h-full relative md:max-h-screen flex flex-col md:flex-row mt-10">
          ...
          <div className=" hidden md:block">
            <LuBookCopy data-aos="zoom-in" data-aos-duration="1000" className=" absolute -top-14 right-80 size-14 text-green-700/20" />
            <GiSecretBook data-aos="zoom-in" data-aos-duration="1000" className=" absolute bottom-10  left-[35rem] size-14 text-green-700/20" />
            <FaBookOpenReader data-aos="zoom-in" data-aos-duration="1000" className=" absolute  -top-28 left-20 size-14 text-green-700/20" />
          </div>
        </div>
        <hr></hr>
        {/* 4 */}
        <div className="h-full relative md:max-h-screen flex flex-col md:flex-row mt-10">
          ...
          <div className=" hidden md:block">
            <BiSolidCameraMovie data-aos="zoom-in" data-aos-duration="1000" className=" absolute  -top-14 right-80 size-14 text-green-700/20" />
            <RiMovie2Fill data-aos="zoom-in" data-aos-duration="1000" className=" animate-pulse absolute bottom-10  left-[35rem] size-14 text-green-700/20" />
            <MdLocalMovies data-aos="zoom-in" data-aos-duration="1000" className=" absolute  -top-28 left-20 size-14 text-green-700/20" />
          </div>
        </div>
